...
- Se o deploy Linux precisar de `libGL.so.1`, o projeto usa um `packages.txt` minimo com `libgl1` apenas, evitando dependencias quebradas do `libglib2.0-0` nesse ambiente do Streamlit Cloud.
